"""
Django settings for ShareJourneysProject project.
...
INSTALLED_APPS = [
    ...
    'ShareJourneysApp.apps.SharejourneysappConfig',
    'ckeditor',
    'ckeditor_uploader',
    'rest_framework',
    'drf_yasg',
...
ROOT_URLCONF = 'ShareJourneysProject.urls'
...
WSGI_APPLICATION = 'ShareJourneysProject.wsgi.application'
